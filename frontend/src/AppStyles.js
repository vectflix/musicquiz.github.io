const styles = {
  ...
  // GENRES
  genreGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(130px, 1fr))', gap: '15px', marginBottom: '40px' },
  genreCard: { padding: '20px', borderRadius: '20px', background: 'rgba(255,255,255,0.03)', textAlign: 'center', fontWeight: 'bold', cursor: 'pointer', border: '1px solid rgba(255,255,255,0.05)', transition: '0.2s' },

  artistGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(180px, 1fr))', gap: '25px', width: '100%' },
  artistCard: { textAlign: 'center', cursor: 'pointer', padding: '20px', background: 'rgba(255, 255, 255, 0.02)', backdropFilter: 'blur(10px)', borderRadius: '30px', border: '1px solid rgba(255, 255, 255, 0.05)', transition: '0.3s' },
  artistImg: { width: '120px', height: '120px', borderRadius: '50%', border: '4px solid rgba(229, 9, 20, 0.2)', marginBottom: '15px', objectFit: 'cover' },
  artistName: { fontSize: '1rem', fontWeight: 'bold', opacity: 0.9 },

  // VIDEO PREVIEW
  videoContainer: { width: '100%', aspectRatio: '16/9', background: '#000', borderRadius: '25px', overflow: 'hidden', border: '1px solid rgba(255,255,255,0.1)', marginBottom: '20px' },

  // NEWS SECTION
  newsSection: { marginTop: '80px', width: '100%' },
  newsGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '20px', marginTop: '20px' },
  ...
  // RANKING BADGES
  rankBadge: { width: '28px', height: '28px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.75rem', fontWeight: '900', marginRight: '15px' },
  gold: { background: 'linear-gradient(45deg, #FFD700, #FFA500)', color: '#000' },
  silver: { background: 'linear-gradient(45deg, #C0C0C0, #8E8E8E)', color: '#000' },
  bronze: { background: 'linear-gradient(45deg, #CD7F32, #8B4513)', color: '#FFF' },
  defaultRank: { background: 'rgba(255,255,255,0.1)', color: '#AAA' },
