...
// --- SUB-COMPONENT: The Timer & Audio Round ---
...
const styles = {
  ...
  goBtn: { background: '#E50914', color: '#fff', border: 'none', padding: '0 20px', borderRadius: '8px', fontWeight: 'bold' },
  ...
  artistBadge: { background: 'rgba(229, 9, 20, 0.2)', color: '#E50914', padding: '5px 15px', borderRadius: '20px', display: 'inline-block', fontWeight: 'bold', fontSize: '0.8rem' },
